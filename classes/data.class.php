...
class getData extends Connection {
	...
	public function updateFinishedPiece($userId){

		$sql = "UPDATE pieces SET checked_out = 'false', checked_id = NULL, checkOutDate = '', finished = 'true', finished_id = '$userId' WHERE checked_id = '$userId'";
